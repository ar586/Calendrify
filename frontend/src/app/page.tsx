    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center p-8 bg-[#F6F5ED] text-[#5E3A21]">
      ...
      <div className="absolute top-0 left-0 w-full p-6 md:px-8 flex justify-between items-center z-50">
        ...
        <div className="flex items-center gap-4">
          <a href="/login" className="font-semibold text-[#8C5E45] hover:text-[#6E3A27] transition-colors text-lg">Log In</a>
      ...
      <div className="z-10 max-w-lg w-full flex flex-col gap-8 bg-[#FCFBFA] p-10 rounded-2xl shadow-sm border border-[#D0C5AE]">
        <div className="text-center">
          ...
          <p className="text-[#8C5E45] text-lg">
            Create an account and set up your profile to generate your schedule.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button type="submit" disabled={loading} className="mt-4 w-full py-4 text-lg font-bold bg-[#8C4A32] text-white rounded-xl shadow hover:bg-[#6E3A27] transition-all disabled:opacity-70 disabled:cursor-not-allowed">
            {loading ? 'Creating Account...' : 'Create Account & View Schedule'}
          </button>
          ...
          }} className="w-full py-4 text-lg font-bold bg-white text-[#5E3A21] border border-[#D0C5AE] rounded-xl shadow-sm hover:bg-gray-50 transition-all flex justify-center items-center gap-2">
          ...
          <p className="text-center text-xs text-[#8C5E45] mt-2">
            Already have an account? <a href="/login" className="font-bold hover:underline">Log in here</a>.
          </p>
        </form>
      </div>

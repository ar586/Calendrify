...
export default function AboutPage() {
    return (
        <main className="relative flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 bg-[#F6F5ED] text-[#5E3A21]">
            ...
            <div className="max-w-3xl w-full bg-[#FCFBFA] px-6 py-8 sm:p-10 md:p-12 rounded-2xl shadow-sm border border-[#D0C5AE] flex flex-col gap-6 sm:gap-8 z-10 my-20 mx-4">
                <div className="text-center">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-[#8C4A32] mb-4">About Calendrify</h1>
                </div>

                <section>
                    <h2 className="text-xl sm:text-2xl font-bold text-[#8C5E45] mb-4 border-b border-[#EAE4D3] pb-2">Core Philosophy</h2>
                    <p className="leading-relaxed text-base sm:text-lg text-[#5E3A21]">
                ...
                <section>
                    <h2 className="text-xl sm:text-2xl font-bold text-[#8C5E45] mb-4 border-b border-[#EAE4D3] pb-2">About the Creator</h2>
                    <p className="leading-relaxed text-base sm:text-lg text-[#5E3A21] mb-6">
                    ...
                    <div className="flex justify-center">
                        <a
                            ...
                            className="inline-flex items-center gap-2 py-3 px-6 sm:py-4 sm:px-8 bg-[#8C4A32] text-white rounded-xl shadow-md hover:bg-[#6E3A27] transition-all font-bold text-base sm:text-lg hover:-translate-y-1"
                        >
